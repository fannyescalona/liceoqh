<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT codigo_cargo, descripcion, (CASE WHEN fecha_desactivacion IS NULL THEN  'Activo' ELSE 'Desactivado' END) AS estatus FROM tcargo";
	...
	$tituloReporte = "Listado de Cargos";
	$titulosColumnas = array('Código Cargo', 'Cargo', 'Estatus');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['codigo_cargo'])
	...
	header('Content-Disposition: attachment;filename="Listado Cargo.xlsx"');
