<?php
	...
	$titulosColumnas = array('Código', 'Nombre', 'Tipo de Ambiente', 'Estatus');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['codigo_ambiente'])
	...
	header('Content-Disposition: attachment;filename="Listado Ambientes.xls"');
