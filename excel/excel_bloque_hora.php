<?php
	...
	$tituloReporte = "Listado Bloque de Hora";
	$titulosColumnas = array('Código', 'Nombre', 'Hora Inicio', 'Hora Fin', 'Turno', 'Receso', 'Estatus');
	...
	header('Content-Disposition: attachment;filename="Listado Bloque Hora.xls"');
