<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT codigo_pais, descripcion, (CASE WHEN fecha_desactivacion IS NULL THEN  'Activo' ELSE 'Desactivado' END) AS estatus FROM tpais ORDER BY codigo_pais ASC";
	...
	$tituloReporte = "Listado de Paises";
	$titulosColumnas = array('Código País', 'País', 'Estatus');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['codigo_pais'])
	...
	header('Content-Disposition: attachment;filename="Listado Pais.xlsx"');
