<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT *, (CASE WHEN fecha_desactivacion IS NULL THEN  'Activo' ELSE 'Desactivado' END) AS estatus from tmateria";
	...
	$objPHPExcel->getActiveSheet()->setTitle('Materia');
	...
	header('Content-Disposition: attachment;filename="Listado Materia.xlsx"');
