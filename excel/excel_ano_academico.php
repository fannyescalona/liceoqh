<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT codigo_ano_academico, descripcion, (CASE WHEN fecha_desactivacion IS NULL THEN  'Activo' ELSE 'Desactivado' END) AS estatus FROM tano_academico";
	...
	$tituloReporte = "Listado de Año Academicos";
	$titulosColumnas = array('Código', 'Año Academico', 'Estatus');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['codigo_ano_academico'])
	...
	$objPHPExcel->getActiveSheet()->setTitle('Año Academico');
	...
	header('Content-Disposition: attachment;filename="Listado Año Academico.xlsx"');
