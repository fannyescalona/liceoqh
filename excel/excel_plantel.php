<?php
	...
	$titulosColumnas = array('Código Parroquia', 'Plantel', 'Direccion', 'Telefono Habitacion', 'Localidad', 'Municipio', 'Estatus');
	...
	header('Content-Disposition: attachment;filename="Listado Plantel.xls"');
