<?php
	...
	$sql=	"select *,
    		...
    		ELSE 'Desactivado' END) AS estatus from tparentesco";
	...
	$tituloReporte = "Listado de Parentesco";
	$titulosColumnas = array('Código', 'Parentesco', 'Estatus');
	...
	while ($row = $mysql->Respuesta($query)){
		$objPHPExcel->setActiveSheetIndex(0)
		->setCellValue('A'.$i, $row['codigo_parentesco'])
	...
	$objPHPExcel->getActiveSheet()->setTitle('Parentesco');
	...
	header('Content-Disposition: attachment;filename="Listado Parentesco.xlsx"');
