<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT m.codigo_municipio, m.descripcion AS municipio, e.descripcion AS estado, p.descripcion AS pais, 
			(CASE WHEN m.fecha_desactivacion IS NULL THEN  'Activo' ELSE 'Desactivado' END) AS estatus 
			FROM tmunicipio AS m
	...
	header('Content-Disposition: attachment;filename="Listado Municipios.xls"');
