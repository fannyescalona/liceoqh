<?php
	...
	$mysql = new Conexion();
	$sql = "SELECT e.codigo_estado, e.descripcion AS estado, p.descripcion AS pais, (CASE WHEN e.fecha_desactivacion IS NULL THEN  'Activo' ELSE 'Desactivado' END) AS estatus 
			FROM testado AS e
			INNER JOIN tpais AS p ON e.codigo_pais = p.codigo_pais ORDER BY e.codigo_estado ASC";
	...
	header('Content-Disposition: attachment;filename="Listado Estado.xls"');
