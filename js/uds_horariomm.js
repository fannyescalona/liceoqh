            ...
            alert(mensaje) 	
			  ...
			  $("td[class=seleccionado]").each(function(i){ 
			      ...
			      $(this).removeClass("seleccionado");
				   datos=$(this).prop("id")+"*"+$("#seccion option:selected").val()+"*"+$("#ambiente option:selected").val()+"*"+$("#materia").val()+"*"+$("#cedula").val();				   
               dia=Array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sabado");
               ...
               if(validar_profesor_horario($(this).prop("id"),$("#cedula").val()))				   
              ...
              function validar_profesor_horario(celda,profesor){
                var is_ok=true;              		
              		elegido1=$("#lapso").val();
            var parametros={ "periodo": elegido1,"profesor": profesor,"celda": celda, "combo": "profesor"  } ;       
              	$.ajax({
                data:  parametros,
                url:   '../controladores/cont_ajax2.php',
                type:  'post',
