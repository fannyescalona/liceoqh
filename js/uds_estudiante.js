...
function init(){
	$("#nacionalidad").change(function(){
	    ...
	    $( "#nacionalidad option:selected" ).each(function() {
	      ...
	      var Url = '../controladores/cont_estudiante.php';
...
permitido=true;
valor=document.getElementById('nacionalidad').value;
valor1=document.getElementById('cedula_estudiante').value;
valor2=document.getElementById('nombre_estudiante').value;
valor3=document.getElementById('apellido_estudiante').value;
