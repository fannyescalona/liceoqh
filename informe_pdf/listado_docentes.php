...
$PHPJasperXML->arrayParameter=array("codigo_materia"=>$codigo_materia!=null ? "'$codigo_materia'" : "null",
	"nro_registro"=>"null");
...
if($PHPJasperXML->query_status==1){
	...
	$Auditoria_Proceso->parametro_valor("{codigo_materia: \'".$codigo_materia."\'}");
