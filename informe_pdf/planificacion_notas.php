...
$PHPJasperXML->arrayParameter=array("codigo_ano_academico"=>"'$codigo_ano_academico'"
	,"cedula_docente"=>"'$cedula_docente'","nro_registro"=>"null");
...
if($PHPJasperXML->query_status==1){
	...
	$Auditoria_Proceso->parametro_valor("{codigo_ano_academico: \'".$codigo_ano_academico."\',cedula_docente: \'".$cedula_docente."\'}");
