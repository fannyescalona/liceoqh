   ...
   //Cabecera de página
    public function Header()
    {
      ...
      $this->Cell(0,6,"\"Sistema de Ingreso Estudiantes y Contol de Notas\"",0,1,"C");
       $this->Ln(15); 
   $this->Cell(0,6,'LISTADO DE LAPSO',0,1,"C");
   $this->Ln(5);
     ...
     $this->SetFillColor(0,0,140); 
         ...
         $this->SetTextColor(0,0,0);
                $this->Cell($avnzar);
                  ...
                  $this->Cell($anchura*3,$altura,'LAPSO',1,0,'L',$color_fondo); 
                  ...
                  $this->Cell($anchura*4,$altura,utf8_decode('AÑO ACADEMICO'),1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
   ...
   //Table with 20 rows and 5 columns
      $lobjPdf->SetWidths(array(20,30,30,30,40,20));
