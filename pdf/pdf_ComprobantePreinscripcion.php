<?php
  ...
  $this->Cell(0,6,"UNIVERSIDAD DEPORTIVA DEL SUR",0,1,"C");
    $this->Cell(0,6,"\"Sistema de Ingreso Estudiantes y Horarios\"",0,1,"C");
       $this->Ln(15); 
   $this->Cell(0,6,'COMPROBANTE PRE-INSCRIPCIÓN',0,1,"C");
      $this->Ln(2);
     ...
     $this->SetFillColor(0,0,140); 
         ...
         $this->SetTextColor(0,0,0);
                $this->Cell($avnzar);
                  ...
                  $this->Cell($anchura*4,$altura,utf8_decode('TELÉFONO 1'),1,0,'L',$color_fondo);
                  $this->Cell($anchura*4,$altura,utf8_decode('TELÉFONO 2'),1,0,'L',$color_fondo);
                  $this->Cell($anchura*4,$altura,'NACIONALIDAD.',1,0,'L',$color_fondo); 
                  $this->Cell($anchura*4,$altura,utf8_decode('DIRECCIÓN'),1,0,'L',$color_fondo); 
