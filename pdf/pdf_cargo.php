   ...
   //Cabecera de página
    public function Header()
    {
      ...
      $this->Cell(0,6,"\"Sistema de Ingreso Estudiantes y Contol de Notas\"",0,1,"C");
       $this->Ln(15); 
   $this->Cell(0,6,'LISTADO DE LOS CARGOS',0,1,"C");
   $this->Ln(5);
     ...
     $this->SetFillColor(0,0,140); 
         ...
         $this->SetTextColor(0,0,0);
                ...
                $this->Cell($anchura*4,$altura,'NOMBRE DEL CARGO',1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
   ...
   //Table with 20 rows and 5 columns
    ...
    ELSE 'Desactivado' END) AS estatus from tcargo";
  $i=-1;
  $data=$mysql->Ejecutar($sql);
    if($mysql->Total_Filas($data)!=0){
        ...
        utf8_decode(ucwords(strtolower(@utf8_decode($tperfil['codigo_cargo'])))),
