   ...
   //Cabecera de página
    public function Header()
    {
      ...
      $this->Cell(0,6,"\"Sistema de Ingreso Estudiantes y Contol de Notas\"",0,1,"C");
       $this->Ln(15); 
   $this->Cell(0,6,'LISTADO DE PARENTESCO',0,1,"C");
   $this->Ln(5);
     ...
     $this->SetFillColor(0,0,140); 
      ...
      $this->Cell($anchura*4,$altura,utf8_decode('PARENTESCO'),1,0,'L',$color_fondo); 
...
function NbLines($w,$txt)
{
  ...
  $data=$mysql->Ejecutar($sql);
    if($mysql->Total_Filas($data)!=0){
         ...
         $lobjPdf->Row(array(
         utf8_decode(ucwords($tperfil['codigo_parentesco'])),
