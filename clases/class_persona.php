...
class Persona {
  ...
  public function Actualizar($oldci){
    if($this->espersonalinstitucion=="Y"){
  ...
  public function ConsultarEstudiante(){
    ...
    $sql.="CONCAT(pi.codigo_parentesco,'_',parent.descripcion) AS codigo_parentesco,pi.peso,pi.estatura,pi.codigo_plantel ";
    $sql.="FROM tpersona p ";
