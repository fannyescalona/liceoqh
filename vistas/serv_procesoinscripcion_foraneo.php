...
<div class="well">
  ...
  <div id="myTabContent" class="tab-content">
    <script src="../js/uds_procesoinscripcion_foraneo.js"></script>
    <div class="tab-pane active in" id="datosestudiantes">
      ...
      <?php
          include_once('serv_datosestudiantes_foraneo.php');
        ?>
    </div>
    <div class="tab-pane" id="datospadres">
      <?php
          include_once('serv_datospadres_foraneo.php');
        ?>
    </div>
    <div class="tab-pane" id="documentosconsignados">
      <?php
          include_once('serv_documentosconsignados_foraneo.php');
        ?>
    </div>
    <div class="tab-pane" id="datosrepresentante">
      <?php
          include_once('serv_datosrepresentantes_foraneo.php');
        ?>
    </div>
  </div>
</div>
