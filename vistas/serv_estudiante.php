          ...
          <div id="contenedorFormulario">
            <div class="row">
              <div class="span6">
                ...
                <input type="hidden" name="edad_maxima_primer_anio" id="edad_maxima_primer_anio" value="<?php echo $edad_maxima_primer_anio; ?>">
                <input tabindex=7 title="Seleccione el fecha de Nacimiento" name="fecha_nacimiento" id="fecha_nacimiento_estudiante" type="text" size="50" value="<?= $fecha_nacimiento;?>" placeholder="Ingrese la Fecha de Nacimiento" class="campoTexto" readonly required />
